...
from transformers.models.bert.modeling_bert import BertForSequenceClassification #수정 전_from transformers.modeling_bert import BertForSequenceClassification
